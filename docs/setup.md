...
Основной вид показывает пять зачётных мест. Раскрываемый полный список
использует `fullEntries` и показывает остальных участников, в том числе ещё не
достигших порога, с `missingMatches` и безопасной причиной исключения.
Характеристики отображаются из готового серверного `achievementContext`; сайт
не ограничивает их выбранным днём, неделей или месяцем.
