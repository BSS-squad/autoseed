...
5. После публикации workflow проверяет доступность страницы, публичный runtime-config и свежесть всех exporter-ов. Снимок старше двух минут считается ошибкой выпуска.
